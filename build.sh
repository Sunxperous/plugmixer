...
uglifyjs ./core/extendAPI.js -c -m -o ./release/current/extendAPI.js

cp ./core/plugmixer.html ./release/current/plugmixer.html

coffee -c ./core/plugmixer.coffee
uglifyjs ./release/plugmixer.define.js ./core/plugmixer.js -c -m -o ./release/current/plugmixer.js

coffee -c ./local/plugmixer_local.coffee
uglifyjs ./release/plugmixer_local.define.js ./local/plugmixer_local.js -c -m -o ./release/current/plugmixer_local.js
